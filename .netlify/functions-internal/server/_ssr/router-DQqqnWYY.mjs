...
var styles_default = "/assets/styles-C2yU6eYZ.css";
...
var Route$1 = createRootRouteWithContext()({
	head: () => ({
		meta: [
			...
			{ title: "Trailblazer Youth Choir — Hymnody Sunday" },
			{
				name: "description",
				content: "RCCG Emmanuel Sanctuary Trailblazer Youth Choir presents Hymnody Sunday 2026."
			},
			{
				name: "author",
				content: "Trailblazer Youth Choir"
			},
			{
				property: "og:title",
				content: "Trailblazer Youth Choir — Hymnody Sunday"
			},
			{
...
var rootRouteChildren = { IndexRoute: createFileRoute("/")({
	head: () => ({ meta: [
		...
		{
			name: "description",
			content: "RCCG Emmanuel Sanctuary Trailblazer Youth Choir presents Hymnody Sunday 2026 — a cinematic worship experience celebrating the songs that have carried faith across generations."
		},
		{
			property: "og:title",
			content: "Trailblazer Youth Choir — Hymnody Sunday 2026"
		},
		{
			property: "og:description",
