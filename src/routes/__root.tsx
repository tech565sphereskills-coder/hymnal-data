...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "RCCG Emmanuel Sanctuary Trailblazer Youth Choir presents Hymnody Sunday 2026." },
      { name: "author", content: "Trailblazer Youth Choir" },
      { property: "og:title", content: "Trailblazer Youth Choir — Hymnody Sunday" },
      { property: "og:description", content: "RCCG Emmanuel Sanctuary Trailblazer Youth Choir presents Hymnody Sunday 2026." },
